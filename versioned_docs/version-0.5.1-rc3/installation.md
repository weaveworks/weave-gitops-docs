...
```console
curl --silent --location "https://github.com/weaveworks/weave-gitops/releases/download/v0.5.1-rc3/tmp
...
```console
Current Version: v0.5.1-rc2-4-gb9e1433c
GitCommit: b9e1433c
BuildTime: 2021-12-08_21:02:43
Branch: HEAD
