...
```console
curl --silent --location "https://github.com/weaveworks/weave-gitops/releases/download/v0.6.0-rc0/tmp
...
```console
Current Version: v0.5.1-rc3-17-g13fb0660
GitCommit: 13fb0660
BuildTime: 2021-12-15_20:13:41
Branch: HEAD
