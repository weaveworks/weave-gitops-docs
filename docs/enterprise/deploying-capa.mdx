...
If you've followed the [Upgrade guide](../enterprise/upgrading.mdx) or [Upgrade EKS guide](../enterprise/upgrading-eks.mdx) you should have a management cluster ready to roll.
