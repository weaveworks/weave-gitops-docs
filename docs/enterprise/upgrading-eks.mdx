...
- `eksctl` [link] (https://github.com/weaveworks/eksctl/releases)
- `aws cli` [link] (https://aws.amazon.com/cli/)
- `clusterclt` >= v1.0.1 [link] (https://github.com/kubernetes-sigs/cluster-api/releases)
- `clusterawsadm` >= v1.1.0 [link] (https://github.com/kubernetes-sigs/cluster-api-provider-aws/releases)
...
Add IAM user to the IAM group created by the previous command. 

The group name should look like the following: `cluster-api-provider-aws-s-AWSIAMGroupBootstrapper-XXXX`
