...
## How to: Install the WGE CLI

The WGE CLI allows you to interact with WGE clusters. You can use `mccp` to manage the lifecycle of your infrastructure declaratively using GitOps. The latest version of the MCCP CLI is available in the following links:
