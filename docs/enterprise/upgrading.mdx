...
- [Linux](https://weaveworks-wkp.s3.amazonaws.com/releases/mccp-latest-linux-amd64)
- [macOS](https://weaveworks-wkp.s3.amazonaws.com/releases/mccp-latest-darwin-amd64)
...
Weave Gitops Enterprise has a number of configration options such as: what type of database to use, which namespace to create clusters in. An important aspect to configure is `Ingress`.
