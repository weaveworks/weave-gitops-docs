...
## Automatically install a CNI

We can use `ClusterResourceSet`s to automatically install calico on a new cluster
...
#### 1. Add a helmrepo and annotate some helm chart
