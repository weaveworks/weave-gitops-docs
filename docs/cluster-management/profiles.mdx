...
The profiles will be sorted by their layer and those at a higher layer will only be installed after lower layers have successfully installed and started. 
